...
export default function EditBatchScreen() {
  ...
  const { batch } = route.params as { batch: any };
  ...
  return (
    <ThemedView style={styles.container}>
      <View style={[styles.header, { paddingTop: insets.top + Spacing.md }]}>
        ...
        <ThemedText type="h3">Edit Batch</ThemedText>
        <View style={{ width: 40 }} />
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.formGroup}>
          ...
          <View style={{ flexDirection: 'row', gap: Spacing.sm }}>
            ...
            />
            <Pressable onPress={() => setShowQuizModal(true)} style={[styles.addTopicButton, { backgroundColor: Colors.light.primary, paddingHorizontal: Spacing.md, borderRadius: BorderRadius.md, justifyContent: 'center' }]}>
        ...
        {topics.map((topic) => (
          <View key={topic.id} style={[styles.topicCard, { backgroundColor: theme.backgroundSecondary, flexDirection: 'row', justifyContent: 'space-between' }]}>
            ...
            <Pressable onPress={() => setTopics(topics.filter(t => t.id !== topic.id))}>
      ...
      <View style={[styles.footer, { paddingBottom: insets.bottom + Spacing.md }]}>
        <Pressable
          ...
          disabled={loading}
        >
          {loading ? <ActivityIndicator color="#fff" /> : <ThemedText type="body" style={styles.createButtonText}>Update Batch</ThemedText>}
        </Pressable>
      </View>
    </ThemedView>
  );
...
const styles = StyleSheet.create({
  ...
  topicCard: { padding: Spacing.md, borderRadius: BorderRadius.md, marginBottom: Spacing.sm, alignItems: 'center' },
  thumbnailContainer: {
    gap: Spacing.xs,
  },
  thumbnailWrapper: {
